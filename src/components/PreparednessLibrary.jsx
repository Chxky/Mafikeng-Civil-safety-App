          ...
          <div key={resource.id} className="card cursor-pointer" onClick={() => setExpanded(expanded === resource.id ? null : resource.id)}>
            <div className="flex items-start justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <svg className={`w-4 h-4 text-gray-400 transition-transform ${expanded === resource.id ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
